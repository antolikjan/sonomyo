...
export const googleAnalyticsMeasurementID = 'G-TBFQD0WP3B'//import.meta.env.PUBLIC_GA_TRACKING_ID // Replace with your Google Analytics Measurement ID (e.g. "G-XXXXXXXXXX")
